...
// O Claude grava em ~/.claude/sessions/<pid>.json o estado da tela: "busy" enquanto responde, "waiting"
// quando pede permissão ou resposta, "idle" parado no prompt. Outros valores ("shell") ficam sem indicador.
